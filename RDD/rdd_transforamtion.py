...
#map_function
x_map=sc.textFile(r"C:\Users\DHINAKARAN\Desktop\New Text Document.txt")
y_map=x_map.flatMap(lambda x:x.split(" "))
print(y_map.collect())


rd1 =y_map.map(lambda x : (x,1))
print(rd1.collect())


rd2=rd1.reduceByKey(lambda y,z:y+z)
print(rd2.collect())
